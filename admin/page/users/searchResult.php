...
<article >
     ...
     <div><form action="searchResult.php" style="margin:0 auto;text-align:center;width:80%">
       ...
       <input hidden type="submit"><a href="users.php?name=<?php echo $name; ?>" >返回</a></form>
       ...
       <table style="border:1px solid darkgray;width:80%;margin:2rem auto;text-align:center" class="table table-striped">
        ...
        <tbody>
          ...
          $sql = "select * from users where phone like '%".$phone."%' and username like '%".$uname."%' and Id like '%".$uid."%' order by Id";
         ...
         <tr>
          ...
          <td>
            ...
            onclick="delUser(this,'<?php echo $name ?>')" class="btn btn-danger" >删除</button>
   ...
   <script>
    ...
    function delPro(elem,name) {
      ...
      $.post("./delUser.php",{
        ...
        location.href="./users.php?name="+name;
      });
     }
    }
      </script>
